...
class Config(object):
    ...
    COMPETITIVE_PRODUCTS_ENDPOINT = getenv('COMPETITIVE_PRODUCTS_ENDPOINT')

    GET_HIERARCHY_ENDPOINT = getenv('GET_HIERARCHY_ENDPOINT')
    
    GET_VDEZI_HIERARCHY = getenv('GET_VDEZI_HIERARCHY')

    EXTRACT_ATTRIBUTES = getenv('EXTRACT_ATTRIBUTES')
    
    GET_NER_ATTRIBUTES = getenv('GET_NER_ATTRIBUTES')
